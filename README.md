...
- Pairs nicely with [Proxify](https://github.com/RileyGuy/Proxify), allowing you to drive registers just by extracting them, or create registers for your registers - if you're into that :)
